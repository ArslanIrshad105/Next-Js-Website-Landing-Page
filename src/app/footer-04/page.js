      ...
      <div className="footer-wrapper">
        <div className="footer-columns">
          <section className="footer-logo-column">
            ...
            <div>
              <h3>Subscribe to our developer newsletter</h3>
              <p>
              ...
              <ul>
                <li>
                  <a href="#" title="Facebook">
                    <img
                      src="assets/media/footer-04/facebook.svg"
                      alt="Facebook"
                    />
                  </a>
                </li>
                <li>
                  <a href="#" title="Instagram">
                    <img
                      src="assets/media/footer-04/instagram.svg"
                      alt="Instagram"
                    />
                  </a>
                </li>
                <li>
                  <a href="#" title="Linkedin">
                    <img
                      src="assets/media/footer-04/linkedin.svg"
                      alt="Linkedin"
                    />
                  </a>
                </li>
                <li>
                  <a href="#" title="Twitter">
                    <img
                      src="assets/media/footer-04/twitter.svg"
                      alt="Twitter"
                    />
                  </a>
                </li>
                <li>
                  <a href="#" title="Youtube">
                    <img
                      src="assets/media/footer-04/youtube.svg"
                      alt="YouTube"
                    />
                  </a>
                </li>
