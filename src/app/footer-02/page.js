            ...
            <ul>
              <li>
                <a href="#" title="Instagram">
                  <img
                    src="assets/media/footer-02/instagram.svg"
                    alt="Instagram"
                  />
                </a>
              </li>
              <li>
                <a href="#" title="Linkedin">
                  <img
                    src="assets/media/footer-02/linkedin.svg"
                    alt="Linkedin"
                  />
                </a>
              </li>
              <li>
                <a href="#" title="Twitter">
                  <img src="assets/media/footer-02/twitter.svg" alt="Twitter" />
                </a>
              </li>
              <li>
                <a href="#" title="Youtube">
                  <img src="assets/media/footer-02/youtube.svg" alt="YouTube" />
                </a>
              </li>
              <li>
                <a href="#" title="GitHub">
                  <img src="assets/media/footer-02/github.svg" alt="GitHub" />
                </a>
              </li>
            </ul>
          </div>
