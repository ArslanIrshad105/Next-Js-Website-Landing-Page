...
const DropdownMenu = () => {
  return (
    <div className="background">
      <nav className="menu__wrapper_04">
        <div className="menu__bar_04">
          <a href="#" title="Logo" className="logo_04">
            <svg
              height="32"
              aria-hidden="true"
              viewBox="0 0 16 16"
          ...
          <ul className="navigation_04 hide">
            <li>
              <button>
                Product
                <svg
              ...
              <div className="dropdown_04">
                <ul className="list-items-with-description_04">
                  <li>
                    <svg
                      aria-hidden="true"
                      height="24"
            ...
            <li>
              ...
              <div className="dropdown_04" _04>
                <h3>For</h3>
                <ul className="list-menu-items_04">
                  <li>
        ...
        <div className="action-buttons_04">
          <a href="#sign-in" title="Sign in" className="secondary_04 hide">
            Sign in
          </a>
          <a href="#sign-up" title="Sign up" className="primary_04">
            Sign up
          </a>
        </div>
        <button className="burger-menu_04">
          <svg
